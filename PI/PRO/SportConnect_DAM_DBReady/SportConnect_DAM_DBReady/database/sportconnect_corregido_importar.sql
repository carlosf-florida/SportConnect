-- SportConnect - SQL corregido para importar en phpMyAdmin
-- Orden correcto para evitar el error: Failed to open the referenced table 'usuarios'
...
DROP VIEW IF EXISTS `vista_ingresos_clases`;
DROP TRIGGER IF EXISTS `evitar_stock_negativo`;
DROP TRIGGER IF EXISTS `reducir_stock`;
DROP PROCEDURE IF EXISTS `suscribirse_clase`;
...
(1,1,1,'2026-04-29 11:25:25'),(2,1,2,'2026-04-29 11:25:25'),(3,3,1,'2026-04-29 11:25:25'),(4,3,4,'2026-04-29 11:25:25'),(5,5,2,'2026-04-29 11:25:25'),
(6,6,3,'2026-04-29 11:25:25'),(7,7,1,'2026-04-29 11:25:25'),(8,7,5,'2026-04-29 11:25:25'),(9,9,6,'2026-04-29 11:25:25'),(10,10,2,'2026-04-29 11:25:25'),
(11,11,4,'2026-04-29 11:25:25'),(12,13,7,'2026-04-29 11:25:25'),(13,14,8,'2026-04-29 11:25:25'),(14,15,1,'2026-04-29 11:25:25'),(15,2,3,'2026-04-29 11:25:25'),
(16,4,5,'2026-04-29 11:25:25'),(17,8,6,'2026-04-29 11:25:25'),(18,12,2,'2026-04-29 11:25:25'),(19,9,8,'2026-04-29 11:25:25'),(20,5,4,'2026-04-29 11:25:25');

INSERT INTO `asistencias` (`id`, `usuario_id`, `clase_id`, `fecha`, `asistio`) VALUES
(1,1,1,'2026-04-29 13:25:25',1),(2,1,2,'2026-04-29 13:25:25',1),(3,3,1,'2026-04-29 13:25:25',1),(4,3,4,'2026-04-29 13:25:25',0),
(5,5,2,'2026-04-29 13:25:25',1),(6,6,3,'2026-04-29 13:25:25',1),(7,7,1,'2026-04-29 13:25:25',1),(8,9,6,'2026-04-29 13:25:25',1),
(9,10,2,'2026-04-29 13:25:25',1),(10,11,4,'2026-04-29 13:25:25',1),(11,13,7,'2026-04-29 13:25:25',0),(12,14,8,'2026-04-29 13:25:25',1);

INSERT INTO `mensajes` (`id`, `remitente_id`, `clase_id`, `contenido`, `fecha_envio`) VALUES
(1,1,1,'¿A qué hora empieza la clase?','2026-04-29 11:25:25'),(2,3,2,'Me gusta mucho este entrenamiento','2026-04-29 11:25:25'),
(3,5,2,'Muy intensa la sesión','2026-04-29 11:25:25'),(4,7,1,'¿Habrá nivel intermedio?','2026-04-29 11:25:25'),
(5,9,6,'Excelente clase de boxeo','2026-04-29 11:25:25'),(6,10,2,'Muy dura pero efectiva','2026-04-29 11:25:25'),
(7,11,4,'Buen ritmo de pilates','2026-04-29 11:25:25'),(8,13,7,'Gran sesión de ciclismo','2026-04-29 11:25:25');

INSERT INTO `pagos` (`id`, `usuario_id`, `clase_id`, `monto`, `fecha_pago`) VALUES
(1,1,2,15.00,'2026-04-29 11:25:25'),(2,3,4,12.00,'2026-04-29 11:25:25'),(3,5,2,15.00,'2026-04-29 11:25:25'),(4,9,6,20.00,'2026-04-29 11:25:25'),
(5,10,2,15.00,'2026-04-29 11:25:25'),(6,11,4,12.00,'2026-04-29 11:25:25'),(7,13,8,18.00,'2026-04-29 11:25:25'),(8,14,8,18.00,'2026-04-29 11:25:25'),
(9,12,2,15.00,'2026-04-29 11:25:25'),(10,4,5,0.00,'2026-04-29 11:25:25');

INSERT INTO `pedidos` (`id`, `comprador_id`, `producto_id`, `cantidad`, `total`, `fecha_pedido`) VALUES
(1,1,1,2,59.98,'2026-04-29 11:25:25'),(2,3,2,1,9.99,'2026-04-29 11:25:25'),(3,5,3,1,14.99,'2026-04-29 11:25:25'),(4,7,4,1,24.99,'2026-04-29 11:25:25'),
(5,9,5,2,39.98,'2026-04-29 11:25:25'),(6,10,1,1,29.99,'2026-04-29 11:25:25'),(7,11,2,3,29.97,'2026-04-29 11:25:25'),(8,13,3,2,29.98,'2026-04-29 11:25:25');

INSERT INTO `valoraciones` (`id`, `usuario_id`, `clase_id`, `puntuacion`, `comentario`, `fecha`) VALUES
(1,1,2,5,'Excelente clase','2026-04-29 11:25:25'),(2,3,4,4,'Muy buena','2026-04-29 11:25:25'),(3,5,2,5,'Intensa pero útil','2026-04-29 11:25:25'),(4,7,1,3,'Normal','2026-04-29 11:25:25'),
(5,9,6,5,'Muy recomendable','2026-04-29 11:25:25'),(6,10,2,4,'Buena experiencia','2026-04-29 11:25:25'),(7,11,4,5,'Perfecto','2026-04-29 11:25:25'),(8,13,7,4,'Bien estructurada','2026-04-29 11:25:25');
...
CREATE OR REPLACE VIEW `vista_ingresos_clases` AS
SELECT 
    c.id,
    c.titulo,
